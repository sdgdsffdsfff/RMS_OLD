...
<head>
    ...
    <script src="js/search/searchQualityProjectRecords.js" type="text/javascript"></script>
</head>
<body style="padding:0px; "> 
  
 <form id="form1" action="searchCollegeQualityProjectRecordInfo.action" method="post"> 
<div id="hippo">
	<ul class="list">
		<li class="til">
	...
	<div id="maingrid" style="margin:0; padding:0">
    	<s:if test="#qualityProjectInfos!=null">
    		<s:iterator value="qualityProjectInfos" id="i">
