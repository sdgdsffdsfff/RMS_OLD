...
<head>
    ...
    <script src="js/search/searchOtherTeachingAwardsRecords.js" type="text/javascript"></script>
</head>
<body style="padding:0px; "> 
  
 <form id="form1" action="searchCollegeOtherTeachingAwardsRecordInfo.action" method="post"> 
<div id="hippo">
	<ul class="list">
		<li class="til">
	...
	<div id="maingrid" style="margin:0; padding:0">
    	<s:if test="#otherTeachingAwardsInfos!=null">
    		<s:iterator value="otherTeachingAwardsInfos" id="i">
