...
<head>
    ...
    <script src="js/search/searchExcellentTrainerRecords.js" type="text/javascript"></script>
</head>
<body style="padding:0px; "> 
  
 <form id="form1" action="searchCollegeExcellentTrainerRecordInfo.action" method="post"> 
<div id="hippo">
	<ul class="list">
		<li class="til">
	...
	<div id="maingrid" style="margin:0; padding:0">
    	<s:if test="#excellentTrainerInfos!=null">
    		<s:iterator value="excellentTrainerInfos" id="i">
