...
<head>
    ...
    <script src="js/search/SearchHumanitiesProject.js" type="text/javascript"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
 ...
 <form id="form1" action="searchCollegeHumanitiesProjectInfo.action" method="post"> 
<div id="hippo">
	<ul class="list">
		<li class="til">
		...
		<li class="item">
			...
			<select class="logical_item" name="stringName1" id="stringName1">
				...
				<option value="projectNumber">项目编号</option>
		...
		<li class="item">
			...
			<select class="logical_item" name="floatName1" id="floatName1">
				<option>请选择</option>
				<option value="money">投入经费</option>
			</select>
		...
		<li class="item">
			...
			<select class="logical_item" name="dateName" id="dateName">
				<option>请选择</option>
				<option value="timeApproved">批准时间</option>
   ...
   <c:if test="${not empty projectInfo}">
     	 <c:forEach items="${projectInfo}" var="projectInfos">
     	 	<script type="text/javascript">
				var row = {projectId: "${projectInfos.project.projectId}",
						projectName: "${projectInfos.project.projectName}", 
						projectNumber: "${projectInfos.project.projectNumber}", 
						projectOrigin: "${projectInfos.project.projectOrigin}", 
						timeApproved:"${projectInfos.project.timeApproved}",
						submitUser:"${projectInfos.project.submitUser.userName}",
						approvedUser:"${projectInfos.project.approvedUser.userName}",
						Status: "${projectInfos.project.status}",
						type: "${type}"
						};
				rows.push(row);
    		 </script>
