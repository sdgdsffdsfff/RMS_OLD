...
<head>
    ...
    <script src="js/search/searchEducationalReformRecords.js" type="text/javascript"></script>
</head>
<body style="padding:0px; "> 
<form id="form1" action="searchCollegeEducationalReformRecordInfo.action" method="post"> 
<div id="hippo">
	<ul class="list">
		<li class="til">
	...
	<div id="maingrid" style="margin:0; padding:0">
    	<s:if test="#educationalReformInfos!=null">
    		<s:iterator value="educationalReformInfos" id="i">
