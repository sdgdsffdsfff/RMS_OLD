...
<s:iterator value="teachAchievementslists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="teachersAwardslists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="achievementsId"/>&modelName=TeachAchievements&idName=achievementsId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="achievementsId"/>&modelName=TeachAchievements&idName=achievementsId" method="post"> 
	    	<br/>
		    <p>
		    	拒绝理由：
