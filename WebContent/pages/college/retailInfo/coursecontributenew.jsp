...
<s:iterator value="courseContributeNewlists" >
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="courseContributeMemberNewlists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="courseId"/>&modelName=CourseContributeNew&idName=courseId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="courseId"/>&modelName=CourseContributeNew&idName=courseId" method="post"> 
	    	<br/>
		    <p>
		        拒绝理由：
