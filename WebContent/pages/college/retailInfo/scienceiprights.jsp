...
<s:iterator  value="scienceIpRightslists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="scienceInventorslists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="rightsId"/>&modelName=ScienceIpRights&idName=rightsId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="rightsId"/>&modelName=ScienceIpRights&idName=rightsId" method="post"> 
	    	<br/>
		    <p>
		  	拒绝理由：
