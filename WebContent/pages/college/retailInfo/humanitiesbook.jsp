...
<s:iterator  value="humanitiesBooklists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="humanitiesBookAuthorlists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div style="text-align:right; padding:0 30px 20px 30px;">
	    <form action="collegeUpdateStatus.action?id=<s:property value="bookId"/>&modelName=HumanitiesBook&idName=bookId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="bookId"/>&modelName=HumanitiesBook&idName=bookId" method="post"> 
	    	<br/>
		    <p>
		        拒绝理由：
