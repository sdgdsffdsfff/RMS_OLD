...
<s:iterator value="scienceGovernmentAwardlists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="scienceGovAwardPersonlists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="awardId"/>&modelName=ScienceGovernmentAward&idName=awardId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="awardId"/>&modelName=ScienceGovernmentAward&idName=awardId" method="post"> 
	    	<br/>
		    <p>
		    	拒绝理由：
