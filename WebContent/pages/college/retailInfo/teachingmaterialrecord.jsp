...
<div id="allpage">
		...
		<div class="content">
			<div class="line">
				<div class="element">
					...
					<input type="text" name="memberName" value='<s:property value="#m.editorName"/>' readonly/>
				</div>
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="#record.id"/>&modelName=TeachingMaterialRecord&idName=id" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="#record.id"/>&modelName=TeachingMaterialRecord&idName=id" method="post"> 
	    	<br/>
		    <p>
		    	拒绝理由：
