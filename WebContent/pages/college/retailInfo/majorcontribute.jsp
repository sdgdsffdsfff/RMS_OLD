...
<s:iterator value="majorContributelists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="majorContributeMemberlists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="majorId"/>&modelName=MajorContribute&idName=majorId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="majorId"/>&modelName=MajorContribute&idName=majorId" method="post"> 
	    	<br/>
		    <p>
		     	拒绝理由：
