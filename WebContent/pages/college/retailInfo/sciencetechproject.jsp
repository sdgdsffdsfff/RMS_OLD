...
<s:iterator value="scienceTechProjectlists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<div class="clear" style="height:15px;"></div>
    	<s:iterator value="scienceDetailTechProjectlists" >
    	<div class="clear" style="height:15px;"></div>
		<div class="content">
			<div class="line">
				<div class="element">
	...
	<div class="item">
		...
		<s:iterator value="scienceTechProjectMemberlists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="projectId"/>&modelName=ScienceTechProject&idName=projectId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="projectId"/>&modelName=ScienceTechProject&idName=projectId" method="post"> 
	    	<br/>
		    <p>
		 		拒绝理由：
