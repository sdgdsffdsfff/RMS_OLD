...
<s:iterator  value="humanitiesPaperlists" >
...
<div id="allpage">
	...
	<div class="item">
		...
		<s:iterator value="humanitiesPaperAuthorlists" >
		<div class="content">
			<div class="line">
				<div class="element">
	...
	<div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="paperId"/>&modelName=HumanitiesPaper&idName=paperId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="paperId"/>&modelName=HumanitiesPaper&idName=paperId" method="post"> 
	    	<br/>
		    <p>
		     	拒绝理由：
