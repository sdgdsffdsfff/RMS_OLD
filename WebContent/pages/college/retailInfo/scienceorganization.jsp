...
<s:iterator  value="scienceOrganizationlists" >
...
<div id="allpage">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="organizationId"/>&modelName=ScienceOrganization&idName=organizationId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="organizationId"/>&modelName=ScienceOrganization&idName=organizationId" method="post"> 
	    	<br/>
		    <p>
		    	拒绝理由：
