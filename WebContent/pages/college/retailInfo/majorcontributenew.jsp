...
<s:iterator value="majorContributeNewlists" >
...
<div id="allpage">
		...
		<div class="content">
			<div class="line">
				...
				<div class="element">
					...
					<input type="text" id="majorName" name="majorName" value='<s:property value="majorName"/>' readonly/>
				</div>
			...
			<div class="line">
				 <div class="element">
					<label for="rewardCollege">奖励金额:</label>
					<input type="text" id="rewardCollege" name="rewardCollege" value='<s:property value="rewardCollege"/>' readonly/>
				</div>
			    <div class="element">
	...
	<div class="item">
		...
		<s:iterator value="majorContributeMemberNewlists" >
		<div class="content">
			<div class="line">
				<div class="element">
    ...
    <div class="item">
	    ...
	    <form action="collegeUpdateStatus.action?id=<s:property value="majorId"/>&modelName=MajorContributeNew&idName=majorId" onsubmit="return checkPassed();" method="post"> 
	    ...
	    <form name="form" onsubmit="return checkReturnReason();" action="collegeUpdateStatus.action?id=<s:property value="majorId"/>&modelName=MajorContributeNew&idName=majorId" method="post"> 
	    	<br/>
		    <p>
		     	拒绝理由：
