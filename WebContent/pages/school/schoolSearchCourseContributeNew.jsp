...
<div class="l-loading" style="display:block" id="pageloading"></div> 
 ...
 <form id="form1" action="searchSchoolCourseContributeNew.action" method="post"> 
...
<div id="hippo">
	<ul class="list">
		...
		<li class="item">
			...
			<select class="logical_item" name="stringName1">
				...
				<option value="author">负责人</option>
			</select>
   ...
   <c:if test="${not empty courseContributeNewInfos}">
     	 <c:forEach items="${courseContributeNewInfos}" var="courseContributeInfo">
     	 	<script type="text/javascript">
				var row = {courseId: "${courseContributeInfo.model.courseId}",
						...
						returnReason: "${courseContributeInfo.model.returnReason}",
						applicantRanking: "${courseContributeInfo.model.applicantRanking}",
						remarks: "${courseContributeInfo.model.remarks}"
						};
				rows.push(row);
    		 </script>
    </c:forEach>
