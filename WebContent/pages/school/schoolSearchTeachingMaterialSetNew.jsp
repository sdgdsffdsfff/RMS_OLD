...
<div class="l-loading" style="display:block" id="pageloading"></div> 
 ...
 <form id="form1" action="searchSchoolTeachingMaterialSetNew.action" method="post"> 
...
<div id="hippo">
   ...
   <c:if test="${not empty teachingMaterialSetsNew}">
     	 <c:forEach items="${teachingMaterialSetsNew}" var="teachingMaterialSetNewInfo">
     	 	<script type="text/javascript">
				var row = {teachingMaterialId: "${teachingMaterialSetNewInfo.model.teachingMaterialId}",
						setClass: "${teachingMaterialSetNewInfo.model.setClass}", 
						numberProject: "${teachingMaterialSetNewInfo.model.numberProject}", 
						teachingMaterialName: "${teachingMaterialSetNewInfo.model.teachingMaterialName}", 
						resultsPostedStatus:"${teachingMaterialSetNewInfo.model.resultsPostedStatus}",
						setTime:"${teachingMaterialSetNewInfo.model.setTime}",
						collegeAward:"${teachingMaterialSetNewInfo.model.collegeAward}",
						submitUser:"${teachingMaterialSetNewInfo.model.submitUser.userName}",
						approvedUser:"${teachingMaterialSetNewInfo.model.approvedUser.userName}",
						Status: "${teachingMaterialSetNewInfo.model.status}",
						 type: "${type}"
							};
				rows.push(row);
    		 </script>
