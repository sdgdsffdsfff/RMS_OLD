...
<div class="l-loading" style="display:block" id="pageloading"></div> 
 ...
 <form id="form1" action="searchSchoolTeachAchievementsCQ.action" method="post"> 
	...
	<ul class="list">
		...
		<li class="item">
			...
			<select class="logical_item" name="dateName" id="dateName">
				<option>请选择</option>
				<option value="timeAchievements">立项时间</option>
				<option value="gradeAchievements">结题时间</option>
			</select>
