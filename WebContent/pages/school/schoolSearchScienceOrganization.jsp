...
<div class="l-loading" style="display:block" id="pageloading"></div> 
 ...
 <form id="form1" action="searchSchoolScienceOrganization.action" method="post"> 
	...
	<ul class="list">
		...
		<li class="item">
			...
			<select class="logical_item" name="floatName1">
				...
				<option value="rdExpenditures">RD支出</option>
		...
		<li class="item">
			...
			<select class="logical_item" name="floatName3">
				<option>请选择</option>
				<option value="totalEmployees">从业人员合计</option>
				<option value="doctorEmployees">博士毕业人数</option>
				<option value="masterEmployees">硕士毕业人数</option>
			...
			<input type="text" class="logical_word"  name="minFloatValue3"/>
			<div class="clear"></div>
			<input type="text" class="logical_word"  name="maxFloatValue3"/>
			<div class="clear"></div>
		</li>
	</ul>
</div>
