...
<body style="padding:0px;">
	<form id="form" name="form" action="submitTeachingMaterialSet.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入教材立项信息
		...
		<div class="content">
			<div class="line">
				<div class="element">
					...
					<input type="text" id="setClass" name="setClass" class=":required" />
				</div>
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="numberProject" name="numberProject" />
				</div>
			</div>
			<div class="line">
				<div class="element">
					<label for="teachingMaterialName">教材名称:</label>
					<input type="text" id="teachingMaterialName" name="teachingMaterialName" />
				</div>
				<div class="element">
					<label for="resultsPostedStatus">是否结贴:</label>
					<input type="text" id="resultsPostedStatus" name="resultsPostedStatus" />
				</div>
			</div>
