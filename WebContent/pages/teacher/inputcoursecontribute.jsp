...
<body style="padding:0px;">
	<form id="form" name="form" action="submitCourseContribute.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入课程建设信息
