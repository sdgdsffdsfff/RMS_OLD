...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyStudentAwardsNew.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="awardsId" name="awardsId" value='<s:property value="awardsId"/>'/>
			<div class="line">
			    <div class="element">
					...
					<input type="text" id="rewardName" name="rewardName" value='<s:property value="rewardName"/>' class=":required" />
				</div>
				
				<div class="element">
					<label for="rewardUnit">颁奖单位:</label>
					<input type="text" id="rewardUnit" name="rewardUnit" value='<s:property value="rewardUnit"/>' class=":required" />
				</div>
				
				<div class="element">
					<label for="rewardLevel">获奖级别:</label>
					<select name="rewardLevel" id="rewardLevel" style="width:155px;height:26px" >
						<s:if test='rewardLevel=="国家级"'>
						...
						<s:elseif test='rewardLevel=="省部级"'>
							<option value="国家级" >国家级</option>
							<option value="省部级" selected="selected">省部级</option>	
							<option value="校级" >校级</option>	
						</s:elseif>
						<s:elseif test='rewardLevel=="校级"'>
							<option value="国家级" >国家级</option>
							<option value="省部级" >省部级</option>	
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="rewardTime" name="rewardTime" value='<s:property value="rewardTime"/>' class=":required" />
				</div>
				
				
				<div class="element">
					<label for="rewardStudents">学生团队成员:</label>
					<input type="text" id="rewardStudents" name="rewardStudents" value='<s:property value="rewardStudents"/>' class=":required" />
				</div>
				
				<div class="element">
					<label for="firstStudents">排名第一的学生姓名:</label>
					<input type="text" id="firstStudents" name="firstStudents" value='<s:property value="firstStudents"/>' class=":required" />
				</div>
			</div>
			<div class="line">
