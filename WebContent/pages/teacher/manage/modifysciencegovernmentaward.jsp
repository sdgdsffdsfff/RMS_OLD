...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyScienceGovernmentAward.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	...
	<div class="item">
		...
		<input type="hidden" id="awardId" name="awardId" value='<s:property value="awardId"/>'/>
			<div class="line">
				<div class="element">
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="completeUnit" name="completeUnit" value='<s:property value="completeUnit"/>' />
				</div>
			</div>
			<div class="line">
			    <div class="element">
					<label for="unitAward">配套单位奖励金额（万元）:</label>
					<input type="text" id="unitAward" name="unitAward" value='<s:property value="unitAward"/>' class=":number"/>
				</div>
				<div class="element">
					<label for="personAward">配套个人奖励金额（万元）:</label>
					<input type="text" id="personAward" name="personAward" value='<s:property value="personAward"/>' class=":number"/>
				</div>
				<div class="element">
					<label for="totalAward">合计奖励金额（万元）:</label>
					<input type="text" id="totalAward" name="totalAward" value='<s:property value="totalAward"/>' class=":number"/>
				</div>
			</div>
			<div class="line">
			    <div class="element">
					<label for="remarks1">备注:</label>
					<input type="text" id="remarks1" name="remarks1" value='<s:property value="remarks"/>' />
				</div>
			</div>
