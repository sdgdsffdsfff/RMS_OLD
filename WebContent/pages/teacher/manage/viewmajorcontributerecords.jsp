    	...
    	<s:iterator value="#allFields" id="d">
     	...
     	<s:iterator value="#records" id="r">
     		<tr>
     			...
     			<td><a href="viewMajorContributeRecordDetail.action?recordId=<s:property value="#r.id"/>">查看详细</a></td>
     			<s:if test="#r.status==0 || #r.status==3">
     				<td><a href="viewMajorContributeRecordDetail.action?recordId=<s:property value="#r.id"/>&flag=modify">修改</a></td>
     			</s:if><s:else>
     				<td></td>
     			</s:else>
