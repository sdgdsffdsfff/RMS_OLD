...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyTeachingMaterialSetNew.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	...
	<div class="item">
		...
		<input type="hidden" id="teachingMaterialId" name="teachingMaterialId" value='<s:property value="teachingMaterialId"/>'/>
			<div class="line">
				<div class="element">
					...
					<select name="setClass" id="setClass" style="width:155px;height:26px" >
						<s:if test='setClass=="正式出版国家规划教材"'>
							<option value="正式出版国家规划教材" selected="selected">正式出版国家规划教材</option>
							<option value="正式出版一般教材" >正式出版一般教材</option>
						</s:if>
						<s:elseif test='setClass=="正式出版一般教材"'>
							<option value="正式出版国家规划教材" >正式出版国家规划教材</option>
							<option value="正式出版一般教材" selected="selected">正式出版一般教材</option>
						</s:elseif>
					</select>
				</div>
				<div class="element">
				...
				<div class="element">
					...
					<select name="numberProject" id="numberProject" style="width:155px;height:26px" >
						<s:if test='numberProject=="专著"'>
						<option value="专著" selected="selected">专著</option>
							<option value="编著" >编著</option>
							<option value="译著" >译著</option>
						</s:if>
						<s:elseif test='numberProject=="编著"'>
						<option value="专著" >专著</option>
							<option value="编著" selected="selected">编著</option>
							<option value="译著" >译著</option>
						</s:elseif>
						<s:elseif test='numberProject=="译著"'>
							<option value="专著" >专著</option>
							<option value="编著" >编著</option>
						<option value="译著" selected="selected">译著</option>
						</s:elseif>
			 		</select>
				</div>
			...
			<div class="line">
				...
				<div class="element">
					<label for="setTime">出版日期:</label>
					<input type="text" id="setTime" name="setTime" value='<s:property value="setTime"/>' />
				</div>
				<div class="element">
					<label for="wordsNumbers">字数（千字）:</label>
					<input type="text" id="wordsNumbers" name="wordsNumbers" value='<s:property value="wordsNumbers"/>' />
				</div>
				...
				<div class="element">
					...
					<input type="text" id="collegeAward" name="collegeAward" value='<s:property value="collegeAward"/>' />
				</div>
		...
		<div class="clear" style="height:15px;"></div>
			...
			<div class="line spe">
				...
				<div class="element del detail">
					<label for="remarksMem">作者排名:</label>
