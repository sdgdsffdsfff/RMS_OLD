...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyMajorContributeNew.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="majorId" name="majorId" value='<s:property value="majorId"/>'/>
			<div class="line">
				<div class="element">
					...
					<input type="text" id="classContribute" name="classContribute" class=":required" value='<s:property value="classContribute"/>'/>
				</div>
				<div class="element">
					<label for="typeContribute">项目类别:</label>
					<input type="text" id="typeContribute" name="typeContribute" class=":required" value='<s:property value="typeContribute"/>'/>
				</div>
				<div class="element">
					<label for="majorName">项目名称:</label>
					<input type="text" id="majorName" name="majorName" class=":required" value='<s:property value="majorName"/>'/>
				</div>
			...
			<div class="line">
				...
				<div class="element">
					...
					<input type="text" id="timeContribute" name="timeContribute" value="${timeContribute}" />
				</div>
				<div class="element">
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="projectSource" name="projectSource" value='<s:property value="projectSource"/>'/>
				</div>
				<div class="element">
					<label for="reportedAmounts">申报金额:</label>
					<input type="text" id="reportedAmounts" name="reportedAmounts" class=":number" value='<s:property value="reportedAmounts"/>'/>
				</div>
				<div class="element">
			...
			<s:if test="%{#memberList == null || #memberList.isEmpty()}">
				<div class="line spe">
					<div class="element del person">
						<label for="memberName">负责人:</label>
