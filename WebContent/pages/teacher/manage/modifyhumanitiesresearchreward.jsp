...
<head>
	...
	<script src="js/teacher/modifyHumResRewardInfo.js" type="text/javascript"></script>
...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyHumanitiesResearchReward.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	...
	<div class="item">
		...
		<input type="hidden" id="researchRewardId" name="researchRewardId" value='<s:property value="researchRewardId"/>'/>
			<div class="line">
				<div class="element">
					<label for="researchRewardName">获奖成果名称:</label>
					<input type="text" id="researchRewardName" name="researchRewardName" value='<s:property value="researchRewardName"/>' class=":required"/>
				</div>
				<div class="element">
					<label for="rewardClassify">获奖类别:</label>
					<input type="text" id="rewardClassify" name="rewardClassify" value='<s:property value="rewardClassify"/>' />
				</div>
				<div class="element">
					<label for="rewardGrades">获奖等级:</label>
					<input type="text" id="rewardGrades" name="rewardGrades" value='<s:property value="rewardGrades"/>' />
				</div>
			</div>
			<div class="line">
				<div class="element">
					<label for="issueUnit">颁发单位:</label>
					<input type="text" id="issueUnit" name="issueUnit" value='<s:property value="issueUnit"/>' />
				</div>
				<div class="element">
					<label for="approveTime"></label>
					<input type="text" id="approveTime" name="approveTime" value="${approveTime}"/>
				</div>
				<div class="element">
					<label for="approveNumber">获奖批准号:</label>
					<input type="text" id="approveNumber" name="approveNumber" value='<s:property value="approveNumber"/>' />
				</div>
			</div>
			...
			<div class="line spe">
				<div class="element del person">
					<label for="memberName">获奖人姓名:</label>
					<input type="text" id="memberName" name="memberName" value='<s:property value="rewardPersonName"/>'/>
				</div>
				<div class="element del detail">
					<label for="remarksMem">备注:</label>
