...
<head>
	...
	<script src="js/teacher/modifyHumBookInfo.js" type="text/javascript"></script>
...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyHumanitiesBook.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="bookId" name="bookId" value='<s:property value="bookId"/>'/>
			<div class="line">
				<div class="element">
					...
					<input type="text" id="bookName" name="bookName" value='<s:property value="bookName"/>' class=":required"/>
				</div>
				<div class="element">
					<label for="grades">等级（专著、编著、译著）:</label>
					<input type="text" id="grades" name="grades" value='<s:property value="grades"/>' class=":required"/>
				</div>
			</div>
			<div class="line">
				<div class="element">
					<label for="publisher">出版单位:</label>
					<input type="text" id="publisher" name="publisher" value='<s:property value="publisher"/>' class=":required"/>
				</div>
				<div class="element">
					<label for="publishedTime"></label>
					<input type="text" id="publishedTime" name="publishedTime" value="${publishedTime}"/>
				</div>
			</div>
			<div class="line">
				<div class="element">
					<label for="iSBN">书号（ISBN）:</label>
					<input type="text" id="iSBN" name="iSBN" value='<s:property value="iSBN"/>' />
				</div>
				<div class="element">
					<label for="wordcount">字数（千字）:</label>
					<input type="text" id="wordcount" name="wordcount" value='<s:property value="wordcount"/>' class=":number"/>
				</div>
				<div class="element">
					<label for="belongProject">成果所属项目:</label>
					<input type="text" id="belongProject" name="belongProject" value='<s:property value="belongProject"/>' />
				</div>
			</div>
			<div class="line">
			    <div class="element">
					<label for="subjectsClassify">学科分类:</label>
					<input type="text" id="subjectsClassify" name="subjectsClassify" value='<s:property value="subjectsClassify"/>' />
				</div>
				<div class="element">
					<label for="achievementQuote">成果引用采纳情况:</label>
					<input type="text" id="achievementQuote" name="achievementQuote" value='<s:property value="achievementQuote"/>' />
				</div>
			</div>
			...
			<div class="line spe">
				<div class="element del person">
					<label for="memberName">作者姓名:</label>
					<input type="text" id="memberName" name="memberName" value='<s:property value="authorName"/>'/>
				</div>
				<div class="element del detail">
					<label for="remarksMem">备注:</label>
