...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyTeachAchievementsNew.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="achievementsId" name="achievementsId" value='<s:property value="achievementsId"/>'/>
			<div class="line">
				<div class="element">
					...
					<select name="classAchievements" id="numberProject" style="width:155px;height:26px" >
						<s:if test='classAchievements=="CSSCI来源"'>
							<option value="CSSCI来源" selected="selected">CSSCI来源</option>
							<option value="CSSCI扩展" >CSSCI扩展</option>
							<option value="北大核心" >北大核心</option>
							<option value="一般" >一般</option>
						</s:if>
						<s:elseif test='classAchievements=="CSSCI扩展"'>
							<option value="CSSCI来源" >CSSCI来源</option>
							<option value="CSSCI扩展" selected="selected">CSSCI扩展</option>
							<option value="北大核心" >北大核心</option>
							<option value="一般" >一般</option>
						</s:elseif>
						<s:elseif test='classAchievements=="北大核心"'>
							<option value="CSSCI来源" >CSSCI来源</option>
							<option value="CSSCI扩展" >CSSCI扩展</option>
							<option value="北大核心" selected="selected">北大核心</option>
							<option value="一般" >一般</option>
						</s:elseif>
						<s:elseif test='classAchievements=="一般"'>
							<option value="CSSCI来源" >CSSCI来源</option>
							<option value="CSSCI扩展" >CSSCI扩展</option>
							<option value="北大核心" >北大核心</option>
				...
				<div class="element">
					...
					<input type="text" id="levelAchievements" name="levelAchievements" value='<s:property value="levelAchievements"/>' class=":required"/>
				</div>
				<div class="element">
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="firstChargeMan" name="firstChargeMan" value='<s:property value="firstChargeMan"/>' />
				</div>
				<div class="element">
					<label for="authorRank">作者排名:</label>
					<input type="text" id="authorRank" name="authorRank" value='<s:property value="authorRank"/>' />
				</div>
				<div class="element">
					<label for="publisher">出版单位:</label>
					<input type="text" id="publisher" name="publisher" value='<s:property value="publisher"/>' />
				</div>
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="wordsNumber" name="wordsNumber" value='<s:property value="wordsNumber"/>' />
				</div>
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="timeAchievements" name="timeAchievements" value="${timeAchievements}" />
				</div>
