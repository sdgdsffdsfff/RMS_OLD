...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyTeacherAwardsRecord.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
			...
			<s:if test="%{#memberList == null || #memberList.isEmpty()}">
				<div class="line spe">
					<div class="element del person">
						<label for="memberName">获奖老师姓名:</label>
