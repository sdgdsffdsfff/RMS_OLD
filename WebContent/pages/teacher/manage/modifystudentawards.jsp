...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyStudentAwards.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="awardsId" name="awardsId" value='<s:property value="awardsId"/>'/>
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="rewardLevel" name="rewardLevel" value='<s:property value="rewardLevel"/>' class=":required"/>
				</div>
				<div class="element">
