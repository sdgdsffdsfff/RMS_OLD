...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyQualityProjectRecord.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
