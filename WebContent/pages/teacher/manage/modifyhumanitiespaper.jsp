...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyHumanitiesPaper.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="paperId" name="paperId" value='<s:property value="paperId"/>'/>
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="publishedGrades" name="publishedGrades" value='<s:property value="publishedGrades"/>' />
				</div>
				<div class="element">
