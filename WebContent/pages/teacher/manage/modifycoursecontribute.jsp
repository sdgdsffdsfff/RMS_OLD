...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyCourseContribute.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
