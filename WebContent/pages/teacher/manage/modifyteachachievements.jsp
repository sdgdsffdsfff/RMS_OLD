...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyTeachAchievements.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
		...
		<input type="hidden" id="achievementsId" name="achievementsId" value='<s:property value="achievementsId"/>'/>
			<div class="line">
				<div class="element">
					...
					<input type="text" id="classAchievements" name="classAchievements" value='<s:property value="classAchievements"/>' class=":required"/>
				</div>
				<div class="element">
