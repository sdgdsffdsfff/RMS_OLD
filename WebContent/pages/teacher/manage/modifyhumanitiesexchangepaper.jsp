...
<head>
	...
	<script src="js/teacher/modifyHumExPaperInfo.js" type="text/javascript"></script>
	<script src="lib/ligerUI/js/ligerui.min.js" type="text/javascript"></script>
	
</head>
<body style="padding:0px;"> 
		
	<form id="form" name="form" action="modifyHumanitiesExchangePaper.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	...
	<div class="item">
		...
		<input type="hidden" id="exchangePaperId" name="exchangePaperId" value='<s:property value="exchangePaperId"/>'/>
			<div class="line">
				<div class="element">
					<label for="exchangePaperName">论文名称:</label>
					<input type="text" id="exchangePaperName" name="exchangePaperName" value='<s:property value="exchangePaperName"/>' class=":required"/>
				</div>
				<div class="element">
					<label for="searchStation">检索情况:</label>
					<input type="text" id="searchStation" name="searchStation" value='<s:property value="searchStation"/>' />
				</div>
				<div class="element">
			...
			<div class="line">
				...
				<div class="element">
					...
					<input type="text" id="hostConferenceName" name="hostConferenceName" value='<s:property value="hostConferenceName"/>' />
				</div>
			</div>
