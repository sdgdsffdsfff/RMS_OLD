...
<head>
	...
	<script src="js/teacher/modifySciIpRightInfo.js" type="text/javascript"></script>
...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyScienceIpRights.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	...
	<div class="item">
		...
		<input type="hidden" id="rightsId" name="rightsId" value='<s:property value="rightsId"/>'/>
			<div class="line">
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="patentName" name="patentName" value='<s:property value="patentName"/>' class=":required"/>
				</div>
				<div class="element">
					<label for="patentType">专利类型:</label>
					<input type="text" id="patentType" name="patentType" value='<s:property value="patentType"/>' />
				</div>
			</div>
			<div class="line">
				<div class="element">
					<label for="applicationNumber">申请号/授权号:</label>
					<input type="text" id="applicationNumber" name="applicationNumber" value='<s:property value="applicationNumber"/>' />
				</div>
				<div class="element">
					<label for="patentStatus">专利状态:</label>
					<input type="text" id="patentStatus" name="patentStatus" value='<s:property value="patentStatus"/>' />
				</div>
				<div class="element">
					<label for="filingDate"></label>
					<input type="text" id="filingDate" name="filingDate" value="${filingDate}"/>
				</div>
			</div>
			<div class="line">
			    <div class="element">
					<label for="announcementDate"></label>
					<input type="text" id="announcementDate" name="announcementDate" value="${announcementDate}"/>
				</div>
				<div class="element">
					<label for="incentivePayments">奖励金额（万元）:</label>
					<input type="text" id="incentivePayments" name="incentivePayments" value='<s:property value="incentivePayments"/>' class=":number"/>
				</div>
			</div>
			<div class="line">
			    <div class="element">
