...
<base href="<%=basePath%>">
<head>
    <title>修改重庆市大学生创新创业训练计划项目信息</title>
...
<body style="padding:0px;"> 
	...
	<form id="form" name="form" action="modifyLearningEvaluationRecord.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
