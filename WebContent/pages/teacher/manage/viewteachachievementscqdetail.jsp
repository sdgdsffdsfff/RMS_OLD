		...
		<input type="hidden" id="achievementsId" name="achievementsId" value='<s:property value="achievementsId"/>' readonly/>
			<div class="line">
				<div class="element">
					...
					<input type="text" id="reportedAmounts" name="reportedAmounts" class=":required" value='<s:property value="reportedAmounts"/>' readonly/>
				</div>
				<div class="element">
					<label for="projectName">项目名称:</label>
					<input type="text" id="projectName" name="projectName" class=":required" value='<s:property value="projectName"/>' readonly/>
				</div>
				<div class="element">
					<label for="timeAchievementsR">立项时间</label>
					<input type="text" id="timeAchievementsR" name="timeAchievementsR" value='<s:property value="timeAchievements"/>' readonly/>
				</div>
				
			</div>
			<div class="line">
				<div class="element">
					<label for="gradeAchievementsR">结题时间</label>
					<input type="text" id="gradeAchievementsR" name="gradeAchievementsR" value='<s:property value="gradeAchievements"/>' readonly/>
				</div>
				
				<div class="element">
					<label for="projectType">类型:</label>
					<input type="text" id="projectType" name="projectType" class=":required" value='<s:property value="projectType"/>' readonly/>
				</div>
				<div class="element">
					<label for="classAchievements">负责人（学生）:</label>
					<input type="text" id="classAchievements" name="classAchievements" class=":required" value='<s:property value="classAchievements"/>' readonly/>
				</div>
			</div>
			<div class="line">
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="certificationUnit" name="certificationUnit" class=":required" value='<s:property value="certificationUnit"/>' readonly/>
				</div>
			...
			<div class="line">
				...
				<div class="element">
					...
					<input type="text" id="verifyAmounts" name="verifyAmounts" class=":number" value='<s:property value="verifyAmounts"/>' readonly/>
				</div>
			</div>
