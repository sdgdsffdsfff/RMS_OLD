...
<head>
	...
	$(function ()
	{
		$("#checkTime").ligerDateEditor({ showTime: true, width: 130, label: '年度检查时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd"});
		$("#endTime").ligerDateEditor({ showTime: true, width: 130, label: '结题时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd"});
	});
	</script>
</head>
<body style="padding:0px;">
	<form id="form" name="form" action="submitMajorContribute.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入专业建设信息
