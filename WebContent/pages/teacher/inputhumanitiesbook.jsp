...
<body style="padding:0px;">
	<form id="form" name="form" action="submitHumanitiesBook.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入人文社科著作信息
		...
		<div class="content">
			<div class="line">
				<div class="element">
					...
					<input type="text" id="bookName" name="bookName" class=":required" />
				</div>
				<div class="element">
					<label for="grades">等级（专著、编著、译著）:</label>
					<input type="text" id="grades" name="grades" class=":required" />
				</div>
			</div>
			<div class="line">
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="humBookPublishedTime" name="publishedTime" />
				</div>
			</div>
			<div class="line">
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="wordcount" name="wordcount" class=":number" />
				</div>
				<div class="element">
