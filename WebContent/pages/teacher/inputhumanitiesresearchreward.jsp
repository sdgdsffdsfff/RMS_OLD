...
<body style="padding:0px;">
	<form id="form" name="form" action="submitHumanitiesResearchReward.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入人文社科科研获奖信息
		...
		<div class="content">
			<div class="line">
				<div class="element">
					...
					<input type="text" id="researchRewardName" name="researchRewardName" class=":required" />
				</div>
				<div class="element">
					<label for="rewardClassify">获奖类别:</label>
					<input type="text" id="rewardClassify" name="rewardClassify" />
				</div>
				<div class="element">
					<label for="rewardGrades">获奖等级:</label>
					<input type="text" id="rewardGrades" name="rewardGrades" />
				</div>
			</div>
			<div class="line">
				<div class="element">
					<label for="issueUnit">颁发单位:</label>
					<input type="text" id="issueUnit" name="issueUnit" />
				</div>
				<div class="element">
					<label for="approveTime"></label>
					<input type="text" id="humRewardApproveTime" name="approveTime" />
				</div>
				<div class="element">
					<label for="approveNumber">获奖批准号:</label>
					<input type="text" id="approveNumber" name="approveNumber" />
				</div>
			</div>
