                ...
                success: function (data) {
                    ...
                    setTimeout(function (){
            			...
            			if(url==null||url==""){
                        	...
                        	$.ligerDialog.error(warning);
                        	$("#loading").html('<a href="downErrorExcel.action?type=hum&url='+url+'">'+warning+'</a>');
                         }
                    },1500);
...
<body style="padding:0px;">
	...
	<div class="item">
	    <div class="title">
			<span style="float:left">导入人文社科类科研信息</span><a style="float:right" href="downExcelModel.action?modelName=Hum">(下载人文社科类科研信息的excel模板)：</a>
			<div style="clear:both"></div>
		</div>
		
		<br/>
		<div style="margin: 0 0 1em 5em">批量导入数据的注意事项：</div>
   	<div style="margin:0 0 5px 7em ;width:700px">1.请使用人文社科科研统计的模板填写相应的信息。</div>
