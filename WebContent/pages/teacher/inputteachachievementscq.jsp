...
<head>
	...
	<title>录入重庆市大学生创新创业训练计划项目信息</title>
	...
	$(function ()
	{
		$("#timeAchievements").ligerDateEditor({ showTime: true, width: 130, label: '立项时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd"});
		$("#gradeAchievements").ligerDateEditor({ showTime: true, width: 130, label: '结题时间', labelWidth: 123,labelAlign: 'center', format: "yyyy-MM-dd"});
...
<body style="padding:0px;">
	<form id="form" name="form" action="submitTeachAchievementsCQ.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入重庆市大学生创新创业训练计划项目信息
			<div class="clear"></div>
		</div>
		<div class="content">
			<div class="line">
				<div class="element">
					...
					<input type="text" id="reportedAmounts" name="reportedAmounts" class=":required" />
				</div>
				<div class="element">
			...
			<div class="line">
				<div class="element">
					<label for="gradeAchievements"></label>
					<input type="text" id="gradeAchievements" name="gradeAchievements"/>
				</div>
				
				<div class="element">
					<label for="projectType">类型:</label>
					<input type="text" id="projectType" name="projectType" class=":required" />
				</div>
				<div class="element">
					<label for="classAchievements">负责人（学生）:</label>
					<input type="text" id="classAchievements" name="classAchievements" class=":required" />
				</div>
			</div>
			<div class="line">
				...
				<div class="element">
					...
					<input type="text" id="certificationUnit" name="certificationUnit" class=":required" />
				</div>
				<div class="element">
				...
				<div class="element">
					...
					<input type="text" id="verifyAmounts" name="verifyAmounts" class=":number" />
				</div>
			</div>
