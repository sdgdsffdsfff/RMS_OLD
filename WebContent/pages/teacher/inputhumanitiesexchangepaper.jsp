...
<body style="padding:0px;">
	<form id="form" name="form" action="submitHumanitiesExchangePaper.action" onsubmit="return checkClickAndSubmit();" method="post" enctype="multipart/form-data">
	<div id="allpage">
	<div class="item">
		<div class="title">
			录入人文社科会议交流论文信息
		...
		<div class="content">
			<div class="line">
				<div class="element">
					...
					<input type="text" id="exchangePaperName" name="exchangePaperName" class=":required" />
				</div>
				<div class="element">
			...
			<div class="line">
				<div class="element">
					...
					<input type="text" id="humExChPaperPublishedTime" name="publishedTime" />
				</div>
				<div class="element">
					<label for="hostConferenceName">主办会议名称:</label>
					<input type="text" id="hostConferenceName" name="hostConferenceName" />
				</div>
			</div>
