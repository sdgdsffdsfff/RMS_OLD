...
public class SearchCollegeLearningEvaluationRecordAction {
	...
	public String execute() {
		 ...
		 * 将动态字段的输出序列化
		 */
		Set<LearningEvaluationData> sortedFields2 = new HashSet<LearningEvaluationData>();
		//获取相应的所有字段
		List<LearningEvaluationField> fields = searchDao.SearchObjectsByFactor("LearningEvaluationField", "isDelete", 0);	
		...
		for(LearningEvaluationField field1 : fields) {
			...
			sortedFields2.add(learningEvaluationData);
