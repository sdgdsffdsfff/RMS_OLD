...
public class SearchCollegeHumanitiesResearchRewardAction extends ActionSupport{
	...
	public String execute(){
		...
		builder.append("{");
		for(int i=0;i<humanitiesResearchRewardInfos.size();i++){
			builder.append(humanitiesResearchRewardInfos.get(i).getModel().getResearchRewardId())
			.append(":{researchRewardId:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getResearchRewardId())
			.append("\",researchRewardName:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getResearchRewardName())
			.append("\",rewardClassify:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getRewardClassify())
			.append("\",rewardGrades:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getRewardGrades())
			.append("\",issueUnit:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getIssueUnit())
			.append("\",approveTime:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getApproveTime())
			.append("\",approveNumber:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getApproveNumber())
			.append("\",submitUser:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getSubmitUser().getUserName())
			.append("\",approvedUser:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getApprovedUser().getUserName())
			.append("\",status:\"").append(humanitiesResearchRewardInfos.get(i).getModel().getStatus())
			.append("\"}");
			if(i+1<humanitiesResearchRewardInfos.size()){
				builder.append(",");
			}
		}
		builder.append("}");
