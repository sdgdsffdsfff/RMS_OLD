...
public class SearchSchoolTeachAchievementsAction extends ActionSupport{
	private SearchCQUPTUserService searchCQUPTUserService;
	private TeachAchievementsService oldteachAchievementsService;
	...
	public void getAllTeachAchievementsInfo(){
		...
		this.teachAchievementsInfos = oldteachAchievementsService.findAllTeachAchievementsInfo(cquptUsers);
	}
	
	public String execute(){
		this.getAllTeachAchievementsInfo();
		this.teachAchievementsInfos = oldteachAchievementsService.searchTeachAchievementsInfoByStringFactor(teachAchievementsInfos, "status", "2");
		if(stringName1==null||stringName1.equals("请选择")){
		}else{
			if(stringValue1==null||stringValue1.equals("")){
			}else{
				teachAchievementsInfos = oldteachAchievementsService.searchTeachAchievementsInfoByStringFactor(teachAchievementsInfos, stringName1, stringValue1);
			}
		}
		if(stringName2==null||stringName2.equals("请选择")){
			...
			if(stringValue2==null||stringValue2.equals("")){
				...
				teachAchievementsInfos = oldteachAchievementsService.searchTeachAchievementsInfoByStringFactor(teachAchievementsInfos, stringName2, stringValue2);
			}
		}
		if(stringName3==null||stringName3.equals("请选择")){
			...
			if(stringValue3==null||stringValue3.equals("")){
				...
				teachAchievementsInfos = oldteachAchievementsService.searchTeachAchievementsInfoByStringFactor(teachAchievementsInfos, stringName3, stringValue3);
			}
		}
		if(stringName4==null||stringName4.equals("请选择")){
			...
			if(stringValue4==null||stringValue4.equals("")){
				...
				teachAchievementsInfos = oldteachAchievementsService.searchTeachAchievementsInfoByStringFactor(teachAchievementsInfos, stringName4, stringValue4);
			}
		}
		if(floatName1==null||floatName1.equals("请选择")){
			...
			if(minFloatValue1==0&&maxFloatValue1==0){
				...
				teachAchievementsInfos = oldteachAchievementsService.searchTeachAchievementsInfoByNumFactor(teachAchievementsInfos, floatName1, minFloatValue1, maxFloatValue1);
			}
		}
