...
public class SearchSchoolCourseContributeAction extends ActionSupport{
	private SearchCQUPTUserService searchCQUPTUserService;
	private CourseContributeNewService courseContributeNewService;
	

	public CourseContributeNewService getCourseContributeNewService() {
		return courseContributeNewService;
	}
	...
	private List<ModelInfo<CourseContributeNew, CourseContributeMemberNew>> courseContributeInfos;
	public List<ModelInfo<CourseContributeNew, CourseContributeMemberNew>> getCourseContributeInfos() {
	...
	public void getAllCourseContributeInfo(){
		...
		this.courseContributeInfos = courseContributeNewService.findAllCourseContributeInfo(cquptUsers);
	}
	
	public String execute(){
		this.getAllCourseContributeInfo();
		courseContributeInfos = this.courseContributeNewService.searchCourseContributeInfoByStringFactor(courseContributeInfos, "status", "2");
		
		if(stringName1==null||stringName1.equals("请选择")){
		}else{
			if(stringValue1==null||stringValue1.equals("")){
			}else{
				courseContributeInfos = courseContributeNewService.searchCourseContributeInfoByStringFactor(courseContributeInfos, stringName1, stringValue1);
			}
		}
		if(stringName2==null||stringName2.equals("请选择")){
			...
			if(stringValue2==null||stringValue2.equals("")){
				...
				courseContributeInfos = courseContributeNewService.searchCourseContributeInfoByStringFactor(courseContributeInfos, stringName2, stringValue2);
			}
		}
		if(stringName3==null||stringName3.equals("请选择")){
			...
			if(stringValue3==null||stringValue3.equals("")){
				...
				courseContributeInfos = courseContributeNewService.searchCourseContributeInfoByStringFactor(courseContributeInfos, stringName3, stringValue3);
			}
		}
		if(stringName4==null||stringName4.equals("请选择")){
			...
			if(stringValue4==null||stringValue4.equals("")){
				...
				courseContributeInfos = courseContributeNewService.searchCourseContributeInfoByStringFactor(courseContributeInfos, stringName4, stringValue4);
			}
		}
		...
		if(floatName1==null||floatName1.equals("请选择")){
			...
			if(minFloatValue1==0&&maxFloatValue1==0){
				...
				courseContributeInfos = courseContributeNewService.searchCourseContributeInfoByNumFactor(courseContributeInfos, floatName1, minFloatValue1, maxFloatValue1);
			}
		}
		...
		if(dateName==null||dateName.equals("请选择")){
			...
			courseContributeInfos = courseContributeNewService.searchCourseContributeInfoByDateFactor(courseContributeInfos, dateName, beginTime, endTime);
		}
		
		System.out.println(cquptColleges.size());
		ActionContext.getContext().put("cquptColleges", cquptColleges);
		System.out.println(courseContributeInfos.size());
