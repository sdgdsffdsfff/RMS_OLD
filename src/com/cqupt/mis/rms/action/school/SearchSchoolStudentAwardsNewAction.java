...
public class SearchSchoolStudentAwardsNewAction extends ActionSupport{
	...
	public void setStudentAwardsNewInfoService(
			StudentAwardsNewInfoService studentAwardsInfoNewService) {
		this.studentAwardsNewInfoService = studentAwardsInfoNewService;
	}
