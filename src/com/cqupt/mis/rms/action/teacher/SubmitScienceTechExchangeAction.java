...
public class SubmitScienceTechExchangeAction extends ActionSupport implements ServletContextAware {
	//注入服务层接口
	...
	public String execute() throws Exception {
		...
		scienceTechExchange.setTechExchangeId(id);
