...
public class ModifyMajorContributeRecordAction extends ActionSupport implements ServletContextAware {
	...
	public String execute() throws Exception {
		 ...
		 * 构建一条记录对象
		 */
		majorContributeRecord.setId(recordId);
		majorContributeRecord.setSubmitUser(user);
		majorContributeRecord.setName(recordName);
		...
		boolean result1 = dynamicDataRecordDao.updateRecord(majorContributeRecord);
		boolean result2 = researchInfoService.modifyProofs(proofs);
		boolean result3 = researchInfoService.modifyResearchMemberInfo(recordId, "MajorRecordMember", "majorContributeRecord", "id", 28, majorRecordMembers);//TODO
