...
/**
*<p>Title:处理教师用户修改人文社科科研获奖信息的Action</p>
*<p>Description:接收用户提交的信息并处理</p>
*@author LvHai
*@version 1.0
**/
@SuppressWarnings("serial")
public class ModifyHumanitiesResearchRewardAction extends ActionSupport implements ServletContextAware {
	//注入接口
	...
	public String execute() throws Exception {
		...
		HumanitiesResearchReward humanitiesResearchReward = (HumanitiesResearchReward)researchInfoDao.findResearchInfoByIdAndModelNameAndFactor(researchRewardId, "HumanitiesResearchReward", "researchRewardId");
		...
		try {
			...
			if(upload != null){
				for (int i = 0; i < upload.length; i++){
			        ...
			        proof.setInfoApprovedId(researchRewardId);
			...
			boolean result1 = researchInfoService.modifyResearchInfo(humanitiesResearchReward);
			boolean result2 = researchInfoService.modifyProofs(proofs);
			boolean result3 = researchInfoService.modifyResearchMemberInfo(researchRewardId, "HumanitiesResearchRewardPerson", "humanitiesResearchReward", "researchRewardId", 11, humanitiesResearchRewardPersons);
			Confirm confirm = new Confirm();
			if(result1 && result2 && result3){
				confirm.setIsSuccess("right");
				confirm.setMessage("科研获奖信息修改成功");
				confirm.setUrl("viewHumanitiesResearchReward.action");
				confirm.setRetName("个人科研获奖信息页面");
			}else{
				confirm.setIsSuccess("error");
				confirm.setMessage("科研获奖信息修改失败");
				confirm.setUrl("viewHumanitiesResearchReward.action");
				confirm.setRetName("个人科研获奖信息页面");
			}
