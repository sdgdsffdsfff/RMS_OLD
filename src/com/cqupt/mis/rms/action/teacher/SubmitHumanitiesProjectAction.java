...
/**
*<p>Title:处理教师用户提交人文社科科研项目基本信息的Action</p>
*<p>Description:接收用户提交的信息并处理</p>
*@author LvHai
*@version 1.0
**/
@SuppressWarnings("serial")
public class SubmitHumanitiesProjectAction extends ActionSupport implements ServletContextAware {
	//注入服务层接口
	...
	public String execute() throws Exception {
		...
		String id = GenerateUtils.getID();//生成基本信息ID
		...
		humanitiesProject.setProjectId(id);
