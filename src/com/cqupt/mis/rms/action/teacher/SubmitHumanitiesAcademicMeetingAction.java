...
/**
*<p>Title:处理教师用户提交人文社科学术会议信息的Action</p>
*<p>Description:接收用户提交的信息并处理</p>
*@author LvHai
*@version 1.0
**/
@SuppressWarnings("serial")
public class SubmitHumanitiesAcademicMeetingAction extends ActionSupport implements ServletContextAware {
	//注入服务层接口
	...
	public String execute() throws Exception {
		...
		humanitiesAcademicMeeting.setAcademicMeetingId(id);
