 ...
 * 2014.9.20
 */
public class LearningEvaluationRecord implements Serializable {
	private String id;		//记录id
	private String name;		//记录的名字
	private String returnReason;		//未通过审核的原因
	private int status;		//记录的状态
	private String statusDes;
	private Set<LearningEvaluationData> fields;		//记录的动态字段
	...
	public Set<LearningEvaluationData> getFields() {
		return fields;
	}
	public void setFields(Set<LearningEvaluationData> fields) {
		this.fields = fields;
	}
